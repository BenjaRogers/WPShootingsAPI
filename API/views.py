...
def get_person_parameterized(current_user):
    ...
    if signs_of_mental_illness:
        people = people.filter(Person.signs_of_mental_illness == bool(signs_of_mental_illness))
    if state:
...
def update_person(current_user, id):
    ...
    updated_person = Person(id=str(data['id']), name=data['name'], date=data['date'], manner_of_death=data['manner_of_death'], armed=data['armed'],age=data['age'], gender=data['gender'], race=data['race'], city=data['city'], state=data['state'], signs_of_mental_illness=data['signs_of_mental_illness'], threat_level=data['threat_level'], flee=data['flee'], body_camera=data['body_camera'], longitude=data['longitude'], latitude=data['latitude'], is_geocoding_exact=data['is_geocoding_exact'])
...
def add_person(current_user):
    ...
    data = request.get_json()
    new_person = Person(id=str(data['id']), name=data['name'], date=data['date'], manner_of_death=data['manner_of_death'], armed=data['armed'],age=data['age'], gender=data['gender'], race=data['race'], city=data['city'], state=data['state'], signs_of_mental_illness=data['signs_of_mental_illness'], threat_level=data['threat_level'], flee=data['flee'], body_camera=data['body_camera'], longitude=data['longitude'], latitude=data['latitude'], is_geocoding_exact=data['is_geocoding_exact'])
